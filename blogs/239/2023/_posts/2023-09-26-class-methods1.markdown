...
Задание на дом - выполнить задание создания класса описывающего рациональную дробь в [http://mdl.sch239.net/](http://mdl.sch239.net/)

Обратите внимание что выше в этой статье есть примеры всего что вам может понадобиться.
