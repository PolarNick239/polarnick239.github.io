...
title:  "[Проект] Как фиксировать камеру на игроке если игровой мир - большой? Эффект тряски камеры"
date:   2025-11-26 0:02:39 +0300
lang:   ru
categories: school239_108_2025_2026
---

Видеозапись урока про камеру вокруг персонажа в большом мире:

- [в VK урок](https://vkvideo.ru/video-232475999_456239036)
- [на YouTube урок](https://youtu.be/CJzruiGtFgI)

В видеозаписи лекции так же рассказывается как сделать **эффект "тряски камеры"**:

<video autoplay loop muted width="632" height="342">
  <source src="/static/2025/11/shaking_camera.mp4" type="video/mp4">
</video>
...
Как теперь сделать тряску камеры?
------

Теперь очень легко добавить подобный спецэффект:

<video autoplay loop muted width="632" height="342">
  <source src="/static/2025/11/shaking_camera.mp4" type="video/mp4">
</video>

Достаточно внутри каждого вызова ```int toScreenX(int worldX)``` и ```int toScreenY(int worldY)``` подкидывать монетку и делать случайное небольшое смещение.

Если вам не нравится что все объекты дергаются в разные стороны, тогда нужно случайное небольшое смещение делать один раз и фиксировать на весь кадр - см. подробнее в видеозаписи урока (ссылка в начале статьи).
