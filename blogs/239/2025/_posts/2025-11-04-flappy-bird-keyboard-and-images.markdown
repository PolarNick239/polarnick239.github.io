...
date:   2025-11-04 09:04:00 +0300
lang:   ru
categories: school239_108_2025_2026
---

Видеозапись про рисование картинки:

- [в VK урок](https://vkvideo.ru/video-232475999_456239033)
- [на YouTube урок](https://youtu.be/Xe7LUR_0gCg)

Видеозапись про обработку клавиатуры и мышки (то есть как добавить управление):

- [в VK урок](https://vkvideo.ru/video-232475999_456239034)
- [на YouTube урок](https://youtu.be/08zR32Fz9NI)
...
public class Main {
    public static void main(String[] args) {
        ...
        frame.setSize(640, 498); // делаем окно нужного размера
