...
date:   2026-09-03 12:04:00 +0300
lang:   ru
categories: school239_108_2026_2027
---

Видеозапись прошлогоднего урока:
...
3. В **JDK** должно быть что-то вроде ``21`` или ``17`` (версия установленного набора разработчика для Java - например **Amazon Corretto 21**), если это не так - нажмите -> выберите под **Detected SDKs** что-то вроде ``C:\Program Files\Amazon Corretto\jdk21...`` или нажмите ``Add JDK...`` и выберите путь **C:\Program Files\Amazon Corretto\jdk...** (не забудьте перед этим установить Java JDK - набор разработчика)
