...
P.S. сдавать это задание можно и вместе со второй частью (отрисовка), но балл будет снижен. При сдаче вместе с третьей частью максимальное что можно получить - 3.
