...
Ниже приведены самые короткие решения. (считаются только символы являющиеся корректными инструкциями, [онлайн счетовод символов](http://simvoli.net/))
...
```Рекорд```: 36 символов - ```+++++++++++++[>+++++>++<<-]>>[<.+>-]``` (10-1 Олейник Иван)
