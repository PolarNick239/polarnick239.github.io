...
date:   2017-01-17 12:00:01 +0300
categories: 239 lesson school java swing game snake
---

Общее описание игры [здесь](/lessons/239/lesson/school/java/swing/game/snake/2017/01/10/Snake-overview.html). Первая часть [здесь](/lessons/239/lesson/school/java/swing/game/snake/2017/01/10/Snake-1-Entities.html).
...
Если вы отправили мне исходники (папку src в архиве) - то вы можете создать по ним проект следующим образом:
 ...
 - Жмите несколько раз Next (по пути смотрите на все значения, но они должны и сами быть верно выставлены), а в конце Finish 
